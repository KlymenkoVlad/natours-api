...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2x5bXZsIiwiYSI6ImNsZ25waG9vdzBkdXEzZHFrbTk0d3c3dHcifQ.O06rYEJ2LpCmefYkZgNuwg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/klymvl/clgnqwbju00dw01qqhdq1hfp6',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfuly. Reload the Page!"));
          }
          _context.next = 12;
          break;
        case 8:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3409" + '/');
